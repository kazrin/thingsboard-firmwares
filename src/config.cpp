...
{
    const char *ssid = "kazrin";
    const char *password = "kazunori3";
    // const char *ssid = "F660A-gphA-G";
    // const char *password = "zfyt9z5h";
}

namespace BasicMQTT
{
    const char *client_id = "aaaaa";
    const char *user_name = "uHLLiDuMB2cOFbpNUKWk";
